...
{
  "id": "ch3-section-gravitational-force-10",
  "level": "2",
  "url": "ch3-section-gravitational-force.html#ch3-section-gravitational-force-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "A.1.1",
  "title": "",
  "body": " View from above of a turntable of radius rotating at constant angular velocity . The unit direction vectors of a local Cartesian coordinate system fixed to the turntable are shown at a point on the edge of the turntable. Vector shows the turntable's constant angular velocity.   Circular disk rotating counter-clockwise about its center viewed from above, with radius and unit direction vectors for a point on its edge.   "
},
{
...
},
{
  ...
  "number": "A.2.1",
  "title": "",
  "body": " Equatorial projection showing the unit direction vectors of a local Cartesian coordinate system fixed to Earth's surface at radius , perpendicular to Earth's axis of rotation, where is Earth's mean radius and is latitude. Vector shows Earth's constant angular velocity.   A point on Earth's surface with the local Cartesian coordinate system placed at that point.   "
},
{
